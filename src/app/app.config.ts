...
export const appConfig: ApplicationConfig = {
  providers: [provideRouter(routes), provideAnimationsAsync(), provideAnimationsAsync(), provideServiceWorker('ngsw-worker.js', {
    ...
    provideHttpClient(withFetch()), importProvidersFrom(provideFirebaseApp(() => initializeApp({ "projectId": "appconex-d8cb0", "appId": "1:703344823544:web:1c489178fb9e30a82b3f0d", "databaseURL": "https://appconex-d8cb0-default-rtdb.firebaseio.com", "storageBucket": "appconex-d8cb0.appspot.com", "apiKey": "AIzaSyBCpqgKJALzSlbVmEeTgU3zqWa5UFew6No", "authDomain": "appconex-d8cb0.firebaseapp.com", "messagingSenderId": "703344823544", "measurementId": "G-P3PCR231KM" }))), importProvidersFrom(provideAuth(() => getAuth())), importProvidersFrom(provideAnalytics(() => getAnalytics())), importProvidersFrom(provideFirestore(() => getFirestore())), importProvidersFrom(provideDatabase(() => getDatabase())), importProvidersFrom(provideMessaging(() => getMessaging())), provideServiceWorker('ngsw-worker.js', {
        enabled: !isDevMode(),
        registrationStrategy: 'registerWhenStable:30000'
    })]
};
