import { Component, inject, ChangeDetectionStrategy, signal, TransferState, PLATFORM_ID, makeStateKey, OnDestroy } from '@angular/core';
...
import { BehaviorSubject, catchError, map, tap, startWith, from, Observable, switchMap } from 'rxjs';
import { Auth, beforeAuthStateChanged, onAuthStateChanged, onIdTokenChanged, signInAnonymously, User } from '@angular/fire/auth';
